    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <a href="#resume" className="text-sm font-medium text-primary hover:text-white transition-colors border border-primary/50 px-4 py-1.5 rounded-full hover:bg-primary/10 ml-2 flex items-center gap-1.5">
