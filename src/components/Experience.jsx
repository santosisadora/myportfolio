...
const experience = [
  {
    ...
    highlights: [
      "MLOps Certification (Duke University)",
      "Graduate Diploma in AI (GRAN Faculdade)"
    ],
    active: true
  },
  {
  ...
  {
    title: "Statistical Data Analyst & Security Analyst Co-ops",
    period: "Pre-2021",
        ...
        <div className="relative border-l border-gray-700 ml-4 md:ml-0 md:left-1/2 md:-translate-x-1/2">
          {experience.map((item, index) => (
            ...
            >
              {/* Timeline dot */}
              <div
                className={`absolute left-[-5px] md:left-1/2 md:-translate-x-1/2 w-3 h-3 rounded-full ${
                  item.active 
